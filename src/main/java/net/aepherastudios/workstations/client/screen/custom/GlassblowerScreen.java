...
import net.aepherastudios.workstations.recipe.recipies.books.GlassblowingRecipebookComponent;
...
public class GlassblowerScreen extends AbstractFurnaceScreen<GlassblowerMenu> {
    private static final ResourceLocation TEXTURE = new ResourceLocation("textures/gui/container/glassblower.png");
