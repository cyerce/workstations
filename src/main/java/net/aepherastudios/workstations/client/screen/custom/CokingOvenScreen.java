...
import net.aepherastudios.workstations.recipe.books.CokingRecipeBookComponent;
...
public class CokingOvenScreen extends AbstractFurnaceScreen<CokingOvenMenu> {
    private static final ResourceLocation TEXTURE =
            new ResourceLocation(ImprovedWorkstations.MOD_ID, "textures/gui/container/coking_oven.png");
